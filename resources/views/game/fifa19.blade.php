...
<div class="owl-carousel-wrapper">
    ...
    <div class="box-92819 shadow-lg">
        ...
        <div>
          <h1 class=" mb-3 text-black text-center">FIFA 19</h1>
            <p>FIFA (dikenal juga sebagai FIFA Football atau FIFA Soccer) adalah seri permainan video yang dirilis oleh perusahaan Electronic Arts di bawah label EA Sports.
              FIFA Soccer pertama kali dirilis pada tanggal 15 juli 1993 dengan judul permainan FIFA International Soccer. FIFA Soccer merupakan permainan video sepak bola 
              pertama yang mendapatkan lisensi langsung dari organisasi FIFA, sebuah lembaga internasional sepak bola. Seri terbaru FIFA menampilkan berbagai Liga dari seluruh dunia.</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="row mb-5 align-items-center">
        <div class="col-md">
          ...
          <br>
          <a href="{{url('/fifa19')}}" class="btn btn-outline-danger btn-md ml-1 mb-3 active">FIFA 19</a>
