...
<div class="owl-carousel-wrapper">
    ...
    <div class="box-92819 shadow-lg">
        ...
        <div>
          <h1 class=" mb-3 text-black text-center">PUBG</h1>
            <p>PlayerUnknown's Battlegrounds (sering disingkat PUBG) adalah sebuah permainan dengan genre battle royale, yang para pemainnya bisa bermain dengan 100 orang sekaligus secara daring. 
              Di dalam permainan ini pemain bisa bermain solo, tim 2 orang, dan tim 4 orang, serta bisa mengundang teman untuk bergabung ke dalam permainan sebagai tim.</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="row mb-5 align-items-center">
        <div class="col-md">
          ...
          <a href="{{url('/pubg')}}" class="btn btn-outline-danger btn-md ml-1 mb-3 active">PUBG</a>
        </div>
      </div>
